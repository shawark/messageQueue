...
func Collector(w http.ResponseWriter, r *http.Request) {
	...
	// Just do a quick bit of sanity checking to make sure the client actually provided us with a command.
	if command == "" {
	...
	work := WorkRequest{Name: name, Delay: delay, Command: command}
